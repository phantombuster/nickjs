...
class Tab {
	...
	isVisible(selectors, operator = null, callback = null) { return this._isVisibleOrPresent("_waitUntilVisible", selectors, operator, callback) }
	...
	deleteCookie(name, domain, callback = null) {
		...
		return this._callToTabDriver((callback) => { this._tabDriver._deleteCookie(name, domain, callback) }, callback)
	}
	...
	scrollToBottom(callback = null) {
		return this._callToTabDriver((callback) => { this._tabDriver._scrollToBottom(x, y, callback) }, callback)
	}
