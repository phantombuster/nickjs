		...
		Promise.all([
			...
			if ((this.__options.whitelist.length > 0) || (this.__options.blacklist.length > 0)) {
				...
				this.__client.Network.requestIntercepted((e) => {
					let auth = null
					if (e.authChallenge && (e.authChallenge.source === "Proxy") && (this.__options.proxyUsername || this.__options.proxyPassword)) {
						auth = {
							response: "ProvideCredentials",
							username: this.__options.proxyUsername,
							password: this.__options.proxyPassword,
						}
					}
